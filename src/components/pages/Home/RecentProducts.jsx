    ...
    <section className='recent'>
        ...
        <div className="container">
            ...
            <div className="recent-category">
                <ul>
                    <li><a onClick={()=>setState(1)} style={{color: state===1 ? 'red' :'black'}} className='active' >{t('Shop.1')}</a></li>
                    <li><a onClick={()=>setState(2)}  style={{color: state===2 ? 'red' :'black'}} >{t('Shop.2')}</a></li>
                    <li><a onClick={()=>setState(3)} style={{color: state===3 ? 'red' :'black'}}>{t('Shop.3')}</a></li>
                    <li><a onClick={()=>setState(4)} style={{color: state===4 ? 'red' :'black'}}>{t('Shop.4')}</a></li>
                    <li><a onClick={()=>setState(5)} style={{color: state===5 ? 'red' :'black'}}>{t('Shop.5')}</a></li>
                </ul>
