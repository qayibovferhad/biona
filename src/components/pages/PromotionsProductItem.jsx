...
const PromotionsProductItem = (props) => {
  ...
  return (
    <div>
           <div class='item'>
           <div data-aos="fade-up" data-aos-anchor-placement="top-bottom" className="promotions-product">
           <div className="promotions-img">
           <div className="promotions-top">
           <span>sale</span>
           </div>
           <img className='promotionsphoto' width={"140px"} src={props.image} alt="" />
           </div>
           <div className="promotions-title">
           <h5>{props.title}</h5>
           <h4><del>${props.del}</del></h4>
           <h4>${props.price}</h4>
